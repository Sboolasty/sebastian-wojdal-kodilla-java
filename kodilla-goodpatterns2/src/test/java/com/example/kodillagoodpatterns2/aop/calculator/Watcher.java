package com.example.kodillagoodpatterns2.aop.calculator;
...
public class Watcher {
    ...
    @Before("execution(* com.example.kodillagoodpatterns2.aop.calculator.Calculator.factorial(..))" +
    ...
    @Around("execution(* com.example.kodillagoodpatterns2.aop.calculator.Calculator.factorial(..))")
